...
[task_local]
#超级直播间盲盒抽京豆
1 20 * * * https://raw.githubusercontent.com/Aaron-lv/JavaScript/master/Task/jd_super_mh.js, tag=超级直播间盲盒抽京豆, enabled=true

==============Loon==============
[Script]
cron "1 20 * * *" script-path=https://raw.githubusercontent.com/Aaron-lv/JavaScript/master/Task/jd_super_mh.js,tag=超级直播间盲盒抽京豆

================Surge===============
超级直播间盲盒抽京豆 = type=cron,cronexp="1 20 * * *",wake-system=1,timeout=3600,script-path=https://raw.githubusercontent.com/Aaron-lv/JavaScript/master/Task/jd_super_mh.js

===============小火箭==========
超级直播间盲盒抽京豆 = type=cron,script-path=https://raw.githubusercontent.com/Aaron-lv/JavaScript/master/Task/jd_super_mh.js, cronexpr="1 20 * * *", timeout=3600, enable=true
*/
...
function mhId(url) {
  ...
  async function retryCdn(code, url) {
    if (code === 'error') {
        ...
        let cndUrl = `https://raw.githubusercontent.com/nianyuguai/longzhuzhu/main/qx/${fn}`
        $.log(`召唤锦鲤失败, 召唤金鱼: ${cndUrl}`)
...
function mhUrl() {
    let url = 'https://raw.githubusercontent.com/nianyuguai/longzhuzhu/main/qx/jd-half-mh.json'
